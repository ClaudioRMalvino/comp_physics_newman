...
def v2(v1, l1):
    """
    Function calculates the velocity of the planetary body at its aphelion 
    by taking its velocityand distance from the Sun at its perihelion,
    as v1 and l1, respectively.
...
def a(l1, l2):
    """
    Function calculates the semi-major axis of the planetary bodies
    orbit provided the distance from the sun at perihelion and aphelion.
...
def b(l1, l2):
    """
    Function calculates the semi-minor axis of the
    planetary bodies orbit provided the distance
...
def orbital_period(a, b, l1, v1):
    """
    Function calculated the orbital period of the plantery body
    provided the semi-major and semi-minor axis, and l1 and v1.
...
def orbital_eccent(l1, l2):
    """
    Function calculates the orbital eccentricity of the planetary body
    provided the distance from the Sunat perihelion and aphelion,
...
def main():
    """
    Function take the user input for v1 and l1 and then returns
    the completed calculations for the following:
    ...
    while True:
        ...
        try:
            ...
            if v1 < 0 or l1 < 0:
                raise ValueError(
                    "l1 & v1 can't have a negative value.\n \
                    Please try again."
                )
            ...
            print(
                f"Distance from Sun at aphelion (l2) = {
                    np.format_float_scientific(l2_val, precision=4)} m"
            )
            print(
                f"Orbital period (T) = {
                    round(T/3.154E+7, 2)} years"
            )
            print(
